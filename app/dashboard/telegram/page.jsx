    ...
    <section className="py-10 bg-black">
      <div className="container mx-auto text-center">
        ...
        <p className="text-lg text-gray-400 mb-12 max-w-2xl mx-auto">
          Upcoming Gameforge.Ai Realtime LeaderBoard ranking for all creators. 
        ...
        <Link href="https://web.telegram.org/k/#@APTOSVERSE_BOT" target="_blank">
          <motion.button
            whileHover={{ scale: 1.1 }}
            whileTap={{ scale: 0.9 }}
            className="bg-transparent border border-white shadow-lg shadow-blue-400/50 hover:shadow-blue-400/80 text-white px-7 py-3 text-xl font-bold rounded-lg transition-all"
          >
           GameForge AI Bot 🤖 
          </motion.button>
        </Link>
