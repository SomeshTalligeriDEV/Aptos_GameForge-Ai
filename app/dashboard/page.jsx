  ...
  return (
    <div className="bg-black text-white font-mono min-h-screen">
      ...
      <motion.div 
        ...
        >
          GAMEFORGE AI <span className="text-gray-500 animate-in">MINIGAMES BY SHADOWDEV</span>
        </motion.h1>
        <motion.p
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
        ...
        >
          Forge the future of gaming with AI-driven intelligence. Built on Aptos. Powered by MOVE
        </motion.p>
