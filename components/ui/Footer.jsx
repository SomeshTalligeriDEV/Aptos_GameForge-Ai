        ...
        <div className="flex flex-col lg:flex-row justify-between items-center gap-8">
          ...
          <div className="flex flex-col items-center gap-6">
            <div className="flex gap-6">
              <Link 
                href="https://www.linkedin.com/in/somesh-s-talligeri-014228331/"
              ...
              <Link
                href="https://www.instagram.com/shadow.dev/"
                className="p-3 bg-white/10 rounded-full hover:bg-white/20 transition-all"
                target="_blank"
              >
              ...
              <Link
                href="https://github.com/SomeshTalligeriDEV"
                className="p-3 bg-white/10 rounded-full hover:bg-white/20 transition-all"
                target="_blank"
              >
        ...
        <div className="mt-12 pt-8 border-t border-white/10">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4 text-gray-400">
            <div className="flex items-center gap-2">
              ...
              <span className="font-bold text-blue-300">AI Technology</span>
            </div>
            
            <div className="flex items-center gap-2">
              <span className="text-sm">❤️ Crafted by</span>
              <span className="font-bold text-purple-300">SHADOW DEV</span>
              <div className="w-2 h-2 bg-green-400 rounded-full animate-pulse"/>
            </div>
            
            <div className="text-sm">
              © {new Date().getFullYear()} GameForge AI. All rights reserved.
            </div>
          </div>
        </div>
      </div>
